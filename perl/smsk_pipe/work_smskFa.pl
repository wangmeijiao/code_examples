...
my %lib=( #for custom libs
          ...
          "mite" => "/home/mjwang/progs/repeatMasker4.0.3/Libraries/p-MITE_db/family/rice.DNA-MITEs.family.fullLen.noTSD.fa",
          "lper"  => "/home/mjwang/progs/repeatMasker4.0.3/Libraries/customed_lib_lper/consensi.fa.classified"
);
...
`bash rpmkout2bedgff_filter.sh $prefix bed 0.1`;
`bash rpmkout2bedgff_filter.sh $prefix gff 0.1`;
...
`bash work_smsk2hmsk.sh ${prefix}.smsk.fa`;
